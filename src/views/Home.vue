<template>
	<div>
		<div class="search-cover">
							...
							<ul class="search-cover_searchbox_results_list">
								<li class="search-cover_searchbox_results_item">
									<a href="" class="search-cover_searchbox_results_link">
										<span>Buscar</span> <span class="font-bold">"Palabra clave"</span> <span>en</span>
										<span class="text-brand font-bold">planificadores</span>
									</a>
								</li>
								<li class="search-cover_searchbox_results_item">
									<a href="" class="search-cover_searchbox_results_link">
			...
			<img src="../assets/meal2-png.png" alt="" class="search-cover_img search-cover_img--left" data-aos="fade-right"
			 data-aos-delay="400">
		...
		<section class="grid-section">
			<div class="grid grid-c--2">
				<div class="search-results_info">
					<h3 class="search-results_title title-md">Últimos planificadores añadidos</h3>
